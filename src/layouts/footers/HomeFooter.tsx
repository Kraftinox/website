                            ...
                            <div className="col-xl-3 col-lg-3 col-md-4">
                                <div className="tp-footer-widget mb-50 tp_fade_anim" data-delay=".5">
                                    ...
                                    <div className="tp-footer-widget-info mb-25">
                                        ...
                                        <span><Link href="mailto:office@kraftszer.ro" aria-label="office@kraftszer.ro"><span className="kf-obf-email" data-u="office" data-d="kraftszer.ro" aria-hidden="true" /></Link></span>
                                        <span><Link href="mailto:technic@kraftszer.ro" aria-label="technic@kraftszer.ro"><span className="kf-obf-email" data-u="technic" data-d="kraftszer.ro" aria-hidden="true" /></Link></span>
                                    </div>
                                    <div className="tp-footer-widget-info mb-25">
